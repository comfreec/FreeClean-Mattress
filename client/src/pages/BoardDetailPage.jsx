      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10 border border-gray-100">
          ...
          <form onSubmit={handleCommentSubmit} className="border-t-2 border-gray-100 pt-8">
            ...
            <div className="space-y-4">
              ...
              <button
                type="submit"
                className="bg-gradient-to-r from-coway-blue to-blue-600 text-white px-6 md:px-8 py-2.5 md:py-3 rounded-xl font-bold hover:shadow-xl hover:scale-105 transition-all inline-flex items-center space-x-2 shadow-lg whitespace-nowrap"
              >
        ...
        <div className="mt-8 flex justify-center px-4">
          <button
            ...
            className="bg-gray-600 text-white px-8 md:px-10 py-3 md:py-4 rounded-xl font-bold hover:bg-gray-700 hover:shadow-lg transition-all inline-flex items-center space-x-2 shadow whitespace-nowrap"
          >
